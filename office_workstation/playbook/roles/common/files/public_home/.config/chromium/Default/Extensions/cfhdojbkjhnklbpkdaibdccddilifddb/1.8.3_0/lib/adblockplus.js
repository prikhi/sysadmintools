...
require.scopes["whitelisting"] = (function()
{
  ...
  var pagesWithKeyException = new ext.PageMap();
  ...
  {
    var urlsWithKeyException = pagesWithKeyException.get(page);
  ...
  var recordKeyException = function(page, url)
  {
    var urlsWithKeyException = pagesWithKeyException.get(page);
  ...
  var processKeyException = exports.processKeyException = function(token, page, frame)
  {
